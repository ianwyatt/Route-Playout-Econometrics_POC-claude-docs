...
|-------------|-----------|---------|
| **Ad playouts** (`mv_playout_15min`) | **6 Aug – 13 Oct 2025** | Actual campaign delivery — **digital frames only** (16,265 frames) |
...
- 94% of the 16,265 digital frames in this POC have mobile index data
...
#### MI Coverage by Venue Proximity
...
8. **94% of the 16,265 digital frames in this POC have mobile index data.** The remaining 6% are frames present in playout data but not matched to an Output Area in the mobile footfall source.
...
| 11 | Geographic | MI coverage analysis by venue proximity |
